	...
	function transform() {
	 ...
	 var sum= parseInt(binary, 2) + parseInt(binary2, 2);
	 var mult= parseInt(binary, 2) * parseInt(binary2, 2);
	 document.write("The sum of these numbers is  ", sum, "     and the product is ", mult, ".");
	 console.log(" Hope you like this!!! ");
	 console.log(" Have a nice day ");}